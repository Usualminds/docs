...
<p>前往 <RouterLink to="/reference/config.html">配置参考</RouterLink> 查看所有 VuePress 配置。</p>
</div>
<h2 id="配置作用域" tabindex="-1"><a class="header-anchor" href="#配置作用域" aria-hidden="true">#</a> 配置作用域</h2>
...
<h3 id="站点配置" tabindex="-1"><a class="header-anchor" href="#站点配置" aria-hidden="true">#</a> 站点配置</h3>
...
<h3 id="主题配置" tabindex="-1"><a class="header-anchor" href="#主题配置" aria-hidden="true">#</a> 主题配置</h3>
<p>主题配置将会被 VuePress 主题来处理，所以它取决于你使用的主题是什么。</p>
<p>如果你没有设置 VuePress 配置的 <code>theme</code> 配置项，则代表使用的是默认主题。</p>
<div class="custom-container tip"><p class="custom-container-title">提示</p>
<p>前往 <RouterLink to="/reference/default-theme/config.html">默认主题 &gt; 配置</RouterLink> 查看默认主题的配置。</p>
</div>
</template>
