<template><h2 id="stylus-loader" tabindex="-1"><a class="header-anchor" href="#stylus-loader" aria-hidden="true">#</a> Stylus loader</h2>
<p>一个 webpack 的 Stylus loader。将 Stylus 文件编译为 CSS。</p>
<h2 id="快速开始" tabindex="-1"><a class="header-anchor" href="#快速开始" aria-hidden="true">#</a> 快速开始</h2>
<p>首先，你需要安装 <code>stylus</code> 和 <code>stylus-loader</code>：</p>
<div class="language-console ext-console line-numbers-mode"><pre v-pre class="language-console"><code>$ npm install stylus stylus-loader --save-dev
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><p>接着按照你习惯的方式运行 <code>webpack</code>。</p>
<h2 id="可选项" tabindex="-1"><a class="header-anchor" href="#可选项" aria-hidden="true">#</a> 可选项</h2>
<table>
<thead>
<tr>
...
<tbody>
<tr>
<td style="text-align:center"><strong><a href="#stylusoptions"><code>stylusOptions</code></a></strong></td>
<td style="text-align:center"><code>{Object|Function}</code></td>
<td style="text-align:center"><code>{}</code></td>
<td style="text-align:left">Stylus 的可选项。</td>
</tr>
<tr>
<td style="text-align:center"><strong><a href="#sourcemap"><code>sourceMap</code></a></strong></td>
<td style="text-align:center"><code>{Boolean}</code></td>
<td style="text-align:center"><code>compiler.devtool</code></td>
<td style="text-align:left">启用/禁用生成 SourceMap。</td>
</tr>
<tr>
<td style="text-align:center"><strong><a href="#webpackimporter"><code>webpackImporter</code></a></strong></td>
<td style="text-align:center"><code>{Boolean}</code></td>
<td style="text-align:center"><code>true</code></td>
<td style="text-align:left">启用/禁用默认的 webpack importer。</td>
</tr>
<tr>
<td style="text-align:center"><strong><a href="#additionaldata"><code>additionalData</code></a></strong></td>
<td style="text-align:center"><code>{String|Function}</code></td>
<td style="text-align:center"><code>undefined</code></td>
<td style="text-align:left">在入口文件起始或末尾添加 <code>Stylus</code> 代码。</td>
</tr>
<tr>
<td style="text-align:center"><strong><a href="#implementation"><code>implementation</code></a></strong></td>
<td style="text-align:center"><code>{String|Function}</code></td>
<td style="text-align:center"><code>stylus</code></td>
<td style="text-align:left">配置 Stylus 使用的实现库。</td>
</tr>
</tbody>
</table>
<h3 id="stylusoptions" tabindex="-1"><a class="header-anchor" href="#stylusoptions" aria-hidden="true">#</a> <code>stylusOptions</code></h3>
<p>类型：<code>Object|Function</code>
默认值：<code>{}</code></p>
<p>通过 <code>stylusOptions</code> 属性，你可以给 <code>stylus-loader</code> 配置 <RouterLink to="/configuration/module/#ruleoptions--rulequery">loader options</RouterLink> 中任意特定的选项值。
所有可用选项可以查看 <a href="https://stylus-lang.com/docs/js.html" target="_blank" rel="noopener noreferrer">Stylus 文档<ExternalLinkIcon/></a>。
这些配置项需要将破折号（dash-case）转换为驼峰值（camelCase）后进行设置。</p>
<h4 id="object" tabindex="-1"><a class="header-anchor" href="#object" aria-hidden="true">#</a> <code>Object</code></h4>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br></div></div><h3 id="webpackimporter" tabindex="-1"><a class="header-anchor" href="#webpackimporter" aria-hidden="true">#</a> <code>webpackImporter</code></h3>
<p>类型：<code>Boolean</code>
默认值：<code>true</code></p>
<p>启用/禁用 webpack 默认的 importer。</p>
<p>在某些情况下，这样做可以提高性能。
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br></div></div><h3 id="additionaldata" tabindex="-1"><a class="header-anchor" href="#additionaldata" aria-hidden="true">#</a> <code>additionalData</code></h3>
<p>类型：<code>String|Function</code>
默认值：<code>undefined</code></p>
<p>在实际入口文件的起始位置添加 <code>Stylus</code> 代码。
这种情况下，<code>stylus-loader</code> 只会<strong>追加</strong>并不会覆盖文件内容。</p>
<p>当你的 Stylus 变量依赖环境变量时这个属性将非常有用：</p>
<blockquote>
<p>ℹ 由于你注入了代码，因此它将破坏入口文件的源映射关系。通常有比这更简单的解决方案，例如多个 Stylus 入口文件。</p>
</blockquote>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br></div></div><h3 id="implementation" tabindex="-1"><a class="header-anchor" href="#implementation" aria-hidden="true">#</a> <code>implementation</code></h3>
<p>类型：<code>Function | String</code></p>
<p>特殊的 <code>implementation</code> 选项决定使用 Stylus 的哪个实现。将会覆盖本地安装的 <code>stylus</code> 的 <code>peerDependency</code> 版本。</p>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br></div></div><h2 id="示例" tabindex="-1"><a class="header-anchor" href="#示例" aria-hidden="true">#</a> 示例</h2>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br></div></div><h3 id="导入-json-文件" tabindex="-1"><a class="header-anchor" href="#导入-json-文件" aria-hidden="true">#</a> 导入 JSON 文件</h3>
<p>Stylus 在 <code>json</code> 函数中无效。
因此 webpack 解析器不适用于 <code>.json</code> 文件。
可使用 <a href="#stylus-resolver"><code>stylus resolver</code></a>。</p>
<p><strong>index.styl</strong></p>
<div class="language-stylus ext-styl line-numbers-mode"><pre v-pre class="language-stylus"><code><span class="token comment">// 假设文件位置在这里 `node_modules/vars/vars.json`</span>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br></div></div><h3 id="生产环境" tabindex="-1"><a class="header-anchor" href="#生产环境" aria-hidden="true">#</a> 生产环境</h3>
<p>在生产环境中推荐使用 <RouterLink to="/plugins/mini-css-extract-plugin/">MiniCssExtractPlugin</RouterLink> 来提取样式表到专门的文件中，这样你的样式就不需要依赖 JavaScript。</p>
<h3 id="webpack-解析器" tabindex="-1"><a class="header-anchor" href="#webpack-解析器" aria-hidden="true">#</a> webpack 解析器</h3>
<p><code>webpack</code> 提供了一种 <RouterLink to="/configuration/resolve/">解析文件的高级机制</RouterLink>。
<code>stylus-loader</code> 将所有的查询结果传递给了 webpack 解析器。
因此你可以从 <code>node_modules</code> 中导入 Stylus 模块。</p>
<div class="language-stylus ext-styl line-numbers-mode"><pre v-pre class="language-stylus"><code><span class="token atrule-declaration"><span class="token atrule">@import</span> <span class="token string">'bootstrap-styl/bootstrap/index.styl'</span><span class="token punctuation">;</span></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><p><code>~</code> 用法已被废弃，可以从代码中删除（<strong>我们建议这么做</strong>），但是我们会因为一些历史原因一直支持这种写法。
为什么你可以移除它呢？loader 首先会尝试以相对路径解析 <code>@import</code>，如果它不能被解析，loader 将会尝试在 <RouterLink to="/configuration/resolve/#resolvemodules"><code>node_modules</code></RouterLink> 中解析 <code>@import</code>。
只要在包名前加上 <code>~</code>，告诉 webpack 在 <RouterLink to="/configuration/resolve/#resolvemodules"><code>modules</code></RouterLink> 中进行查找。</p>
<div class="language-stylus ext-styl line-numbers-mode"><pre v-pre class="language-stylus"><code><span class="token atrule-declaration"><span class="token atrule">@import</span> <span class="token string">"~bootstrap-styl/bootstrap/index.styl"</span><span class="token punctuation">;</span></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><p>重要的是只在它的前面加上 <code>~</code>，因为 <code>~/</code> 会被解析到根目录。
<code>webpack</code> 需要区分 <code>bootstrap</code> 和 <code>~bootstrap</code>，因为 CSS 和 Stylus 文件没有特殊的语法可以导入相对路径的文件。
<code>@import &quot;file&quot;</code> 和 <code>@import &quot;./file&quot;;</code> 写法是等价的。</p>
<h3 id="stylus-resolver" tabindex="-1"><a class="header-anchor" href="#stylus-resolver" aria-hidden="true">#</a> Stylus resolver</h3>
<p>如果指定 <code>paths</code> 选项，将从指定的 <code>paths</code> 中搜索模块。
这是 Stylus 的默认行为。</p>
<p><strong>webpack.config.js</strong></p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  <span class="token literal-property property">module</span><span class="token operator">:</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br></div></div><h3 id="提取样式" tabindex="-1"><a class="header-anchor" href="#提取样式" aria-hidden="true">#</a> 提取样式</h3>
<p>通过 webpack 打包 CSS 有很多好处，比如给引用图片和字体文件路径添加 hash, 在开发环境可以<RouterLink to="/concepts/hot-module-replacement/">模块热更新</RouterLink>。另一方面，在生产环境，根据 JS 来控制应用样式表不是一个好的方式，可能会导致延迟渲染，甚至可能会出现<a href="https://en.wikipedia.org/wiki/Flash_of_unstyled_content" target="_blank" rel="noopener noreferrer">闪烁现象<ExternalLinkIcon/></a>。因此，在你最终的生产环境中将它们拆分成单独的文件来存放通常是比较好的选择。</p>
<p>有两种从 bundle 中提取样式表的方式：</p>
<ul>
<li><a href="https://github.com/peerigon/extract-loader" target="_blank" rel="noopener noreferrer"><code>extract-loader</code><ExternalLinkIcon/></a> （简单，但得专门指定 <code>css-loader</code> 的 output）</li>
<li><RouterLink to="/plugins/mini-css-extract-plugin/">MiniCssExtractPlugin</RouterLink> （较复杂，但适用于所有的场景）</li>
</ul>
<h2 id="贡献" tabindex="-1"><a class="header-anchor" href="#贡献" aria-hidden="true">#</a> 贡献</h2>
<p>如果你还没有看过我们的贡献者指南请先花点时间看一下。</p>
<p><a href="https://github.com/webpack-contrib/stylus-loader/blob/master/.github/CONTRIBUTING.md" target="_blank" rel="noopener noreferrer">CONTRIBUTING<ExternalLinkIcon/></a></p>
<h2 id="许可" tabindex="-1"><a class="header-anchor" href="#许可" aria-hidden="true">#</a> 许可</h2>
<p><a href="https://github.com/webpack-contrib/stylus-loader/blob/master/LICENSE" target="_blank" rel="noopener noreferrer">MIT<ExternalLinkIcon/></a></p>
</template>
