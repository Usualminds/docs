...
<p>伴随互联网的快速发展，Web 服务已呈现出极速增长的趋势，人们在使用 Web 服务的同时，也面临着网络安全风险。根据中国信息通信研究院发布的<a href="http://www.caict.ac.cn/kxyj/qwfb/bps/202009/P020200916482039993423.pdf" target="_blank" rel="nofollow noopener noreferrer">《中国网络安全产业白皮书》<ExternalLinkIcon/></a>报告：我国网络安全产业呈现高速增长态势，2020 年产业规模预计为 1702 亿元。</p>
...
<p>浏览器指纹是由<a href="https://www.eff.org/" target="_blank" rel="nofollow noopener noreferrer">电子前哨基金会 (EFF)<ExternalLinkIcon/></a> 首席科学家 <a href="https://www.xprize.org/about/people/peter-eckersley" target="_blank" rel="nofollow noopener noreferrer">Peter Eckersley<ExternalLinkIcon/></a> 在 2012 年提出，它利用浏览器自由传输的一些属性来生成和人类指纹一样具有标识作用的字符串。那么常见的浏览器指纹有哪些呢？可以参考如下表格数据，其中：</p>
<ul>
...
<blockquote>
<p>表格指纹因子数据源：<a href="https://github.com/fingerprintjs/fingerprintjs/blob/v2/wiki/browser_independent_components.md" target="_blank" rel="nofollow noopener noreferrer">Browser independent components
<ExternalLinkIcon/></a> &amp; <a href="https://github.com/fingerprintjs/fingerprintjs/blob/v2/wiki/stable_components.md" target="_blank" rel="nofollow noopener noreferrer">Stable components<ExternalLinkIcon/></a></p>
</blockquote>
...
<blockquote>
<p>Note：点击<a href="http://home.ustc.edu.cn/~yang96/Elements_of_Information_Theory-second_edition.pdf" target="_blank" rel="nofollow noopener noreferrer">信息论基础<ExternalLinkIcon/></a>进行穿越复习。</p>
</blockquote>
<h3 id="多个指纹因子概率" tabindex="-1"><a class="header-anchor" href="#多个指纹因子概率" aria-hidden="true">#</a> 多个指纹因子概率</h3>
<p>知道了如何计算单个指纹因子的信息熵，我们就可以进一步对浏览器的多个指纹因子进行信息熵的合并计算。根据 <a href="https://www.xprize.org/about/people/peter-eckersley" target="_blank" rel="nofollow noopener noreferrer">Peter Eckersley<ExternalLinkIcon/></a> 发布的论文 <a href="https://coveryourtracks.eff.org/static/browser-uniqueness.pdf" target="_blank" rel="nofollow noopener noreferrer">How Unique Is Your Web Browser<ExternalLinkIcon/></a> 结果表明：通过 <code v-pre>userAgent</code>、<code v-pre>fonts</code>、<code v-pre>screenResolution</code> 和 <code v-pre>plugins</code> 等八个指纹因子来生成浏览器指纹：</p>
...
<p>目前，云服务器和虚拟主机已相对普及了，随时可以克隆出多个一模一样的虚拟系统和设备，类似 <a href="https://baike.baidu.com/item/ghost%E7%B3%BB%E7%BB%9F/8452726" target="_blank" rel="nofollow noopener noreferrer">ghost 系统<ExternalLinkIcon/></a>，它们在初始化状态下指纹大概率是相同的，这时我们怎么去识别这些”出厂设置 “相同的设备呢？</p>
<p>上述我们提出的指纹识别是基于静态规则的识别，即只识别一次，但是真实的情况是一个设备的指纹是会随着时间发生变化的，它完全和使用者的习惯相关联，举例来说：如果今天你给自己的浏览器安装了一个插件，这时浏览器的指纹就会发生变化。因此，基于静态规则和动态追踪的关联机制可以实现对设备指纹指纹演变的长期追踪。有兴趣的童鞋可以参考 <a href="https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&amp;arnumber=8418634" target="_blank" rel="nofollow noopener noreferrer">FP-STALKER：Tracking Browser Fingerprint Evolutions<ExternalLinkIcon/></a> 的研究结果：，一个浏览器可以被追踪的平均时间已经超过 <strong>54.48</strong> 天。在追踪过程中，对指纹数据集进行再分类，可以有效的规避这类问题。</p>
...
<p>除了网络上等爬虫工具，还会有各种专业的 Web 漏洞扫描工具，如：<a href="https://www.acunetix.com/" target="_blank" rel="nofollow noopener noreferrer">AWVS<ExternalLinkIcon/></a>、<a href="https://www.hcltechsw.com/products/appscan" target="_blank" rel="nofollow noopener noreferrer">APPScan<ExternalLinkIcon/></a>、<a href="https://xray.cool/" target="_blank" rel="nofollow noopener noreferrer">Xray<ExternalLinkIcon/></a> 等，扫描器在主动识别 Web 漏洞的同时，也会给线上 Web 服务带来潜在安全问题。针对扫描器的拦截，可以根据其浏览器指纹的特异性，在其扫描指定站点时，进行识别与拦截。</p>
...
<p>当你在网上浏览或者查找相关商品时，是不是经常会出现与之相关的广告页面？这时你很有可能正在被跟踪，因为你的屏幕分辨率、时区和表情符号集这些信息都暴露在了网上。甚至可以在你使用无痕浏览模式时跟踪你，有兴趣可以查看<a href="https://www.nothingprivate.ml/" target="_blank" rel="nofollow noopener noreferrer">这里<ExternalLinkIcon/></a>。</p>
...
<ul>
<li><a href="https://www.xprize.org/about/mission" target="_blank" rel="nofollow noopener noreferrer">xprize<ExternalLinkIcon/></a></li>
<li><a href="https://github.com/fingerprintjs/fingerprintjs" target="_blank" rel="nofollow noopener noreferrer">fingerprintjs<ExternalLinkIcon/></a></li>
<li><a href="http://home.ustc.edu.cn/~yang96/Elements_of_Information_Theory-second_edition.pdf" target="_blank" rel="nofollow noopener noreferrer">信息论基础<ExternalLinkIcon/></a></li>
<li><a href="https://coveryourtracks.eff.org/learn" target="_blank" rel="nofollow noopener noreferrer">How do trackers work？<ExternalLinkIcon/></a></li>
<li><a href="https://github.com/xitu/gold-miner/blob/master/article/2021/we-collected-500-000-browser-fingerprints-here-is-what-we-found.md" target="_blank" rel="nofollow noopener noreferrer">基于 50 万个浏览器指纹的新发现<ExternalLinkIcon/></a></li>
<li><a href="https://coveryourtracks.eff.org/static/browser-uniqueness.pdf" target="_blank" rel="nofollow noopener noreferrer">How Unique Is Your Web Browser？<ExternalLinkIcon/></a></li>
<li><a href="https://amiunique.org/" target="_blank" rel="nofollow noopener noreferrer">Learn how identifiable you are on the Internet<ExternalLinkIcon/></a></li>
<li><a href="https://hal.inria.fr/hal-01285470/file/beauty-sp16.pdf" target="_blank" rel="nofollow noopener noreferrer">Beauty and the Beast：Diverting modern web browsers
